...
class Rectangle(Shape):
    def __init__(self, x1, y1, x2, y2, border_char = None, fill_char = None):
        super().__init__()
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
    ...
    def get_parameters(self):
        return f"x1 = {self.x1}, y1 = {self.y1}, x2 = {self.x2}, y2 = {self.x2}, border = '{self.border_char}', fill = '{self.fill_char}'"
